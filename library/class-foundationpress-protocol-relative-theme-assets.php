 ...
 *
 * @package ASMagazine
 * @since ASMagazine 1.1.0
 */

if ( ! class_exists( 'asmagazine_Protocol_Relative_Theme_Assets' ) ) :
	class asmagazine_Protocol_Relative_Theme_Assets {
		/**
	...
	$asmagazine_protocol_relative_theme_assets = new asmagazine_Protocol_Relative_Theme_Assets;
endif;
