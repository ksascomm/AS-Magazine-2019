...
This theme is built off [ASMagazine](https://github.com/olefredrik/ASMagazine).
...
### 4. Configuration ([Copied from ASMagazine](https://github.com/olefredrik/ASMagazine))
...
### Project structure ([Copied from ASMagazine](https://github.com/olefredrik/ASMagazine))
...
### JavaScript Compilation ([Copied from ASMagazine](https://github.com/olefredrik/ASMagazine))
...
## Requirements ([Copied from ASMagazine](https://github.com/olefredrik/ASMagazine))
