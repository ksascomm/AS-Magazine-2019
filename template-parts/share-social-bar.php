...
<div class="share-section">
	...
	<ul class="menu">
		...
		<li>
			<a href="https://twitter.com/intent/tweet?text=<?php echo rawurlencode( get_the_title() ); ?>&amp;url=<?php echo rawurlencode( get_permalink() ); ?>&amp;via=JHUArtsSciences" target="_blank" aria-label="Share this on Twitter"><span class="fa-brands fa-x-twitter fa-2x"></span><span class="screen-reader-text">Twitter</span></a>
		</li>
	</ul>
</div>
